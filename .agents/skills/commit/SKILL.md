...
dependency/security work, or something another Codex session pushed. Anything that
...
No `Co-Authored-By` trailer and no "Generated with Codex" footer, in commit
